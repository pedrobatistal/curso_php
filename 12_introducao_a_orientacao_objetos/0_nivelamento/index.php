<!--O que sao objetos? 
Objetos são entidades que possuem comportamentos e caracteristicas;
As caracteristicas são conhecidas como propriedades (variáveis);
...
A classe contém o molde do objeto, ou seja, ses métodos e suas propriedades;
